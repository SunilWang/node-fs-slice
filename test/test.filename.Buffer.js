...
test.before('init', async function () {
  let imgeBuffer = await streamToBuffer(IMAGE_FILENAME)
  let textBuffer = await streamToBuffer(TEXT_FILENAME)
  fsImage = fss(imgeBuffer, { blockSize: 204800 })
  fsText = fss(textBuffer, { blockSize: 204800 })
})
...
test('should slice success', async function (t) {
  let readable = fsImage.slice()
  let tempFilename = './test/temp/buffer/slice_temp.jpg'
...
test('should sliceAsFile success', function * (t) {
  let tempFilename = './test/temp/buffer/sliceAsFile_temp.jpg'
...
test('should sliceAsFile by text success', function * (t) {
  let tempFilename = './test/temp/buffer/sliceAsFile_text_temp'
...
test('should sliceAsFile default interval success', function * (t) {
  let tempFilename = './test/temp/buffer/sliceAsFile_default_interval_temp.jpg'
...
test('should join success', function * (t) {
  let tempFilename = './test/temp/buffer/join_temp'
...
test('should joinAsFile success', function * (t) {
  let tempFilename = './test/temp/buffer/joinAsFile_temp'
  let res = yield fsText.avgSliceAsFile()
