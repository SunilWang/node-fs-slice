...
class FsSlice {
   ...
   * @private
   */
  _getBlockInterval (index, blockSize) {
  ...
  sliceAsFile (filepath, rOptions = {}, wOptions = {}) {
    if (!filepath) {
  ...
  joinAsFile (filenameArray, filepath) {
